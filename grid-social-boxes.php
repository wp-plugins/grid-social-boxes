...
function grid_social_boxes_define_boxes() {
	/**
	 * twitter box
	 */
	grid_social_boxes_include_twitter_api();
...
add_action( 'grid_load_classes', 'grid_social_boxes_define_boxes' );


function grid_social_boxes_admin_menu() {
	add_submenu_page( 'options-general.php', 'Grid Social Boxes', 'Grid Social Boxes', 'manage_options', 'grid_social_boxes_settings', 'grid_social_boxes_settings' );
	add_submenu_page( null, 'Grid Twitter Callback', 'Grid Twitter Callback', 'manage_options', 'grid_social_boxes_twitterbox_callback', 'grid_social_boxes_twitterbox_callback' );
}
add_action( 'admin_menu', 'grid_social_boxes_admin_menu' );

function grid_social_boxes_settings() {
	grid_social_boxes_include_twitter_api();
...
function grid_social_boxes_twitterbox_callback() {
	grid_social_boxes_include_twitter_api();
	session_start();
 ...
 */
function grid_social_boxes_include_twitter_api(){
